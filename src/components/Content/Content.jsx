      ...
      const response = await axios.post(
        ...
        },
        {
          headers: {
            ...
            Authorization:
              "Bearer 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",
          },
        }
      );
                          ...
                          return (
                            ...
                            >
                              {index % 2 === 0 ? (
                                ...
                                <img
                                  src="\images\chatgpt-icon-logo.png"
                                  alt="Ảnh"
                                  style={{
                                    width: "42px",
                                    height: "44px",
                    ...
                    {listMessage.length ? null : (
                      ...
                      >
                        <Typography
                          ...
                          sx={{
                            background:
                              "linear-gradient(204.7deg, #787878 -18.61%, #232323 82.59%)",
                            WebkitBackgroundClip: "text",
                            WebkitTextFillColor: "transparent",
                            backgroundClip: "text",
                            textFillColor: "transparent",
                            textShadow:
                              "rgba(105, 105, 105, 1), 0.55px rgba(70, 70, 70, 1)",
                          }}
                        >
                          ChatGPT
                          <br />
